<div id="gbb-builder">
   <div class="gbb-block-title">
    <?php print 'Edit: ' ?><?php print $gbb_title ?> ( ID: <?php print $gbb_id ?> | <a href="<?php print \Drupal::url('gavias_blockbuilder.admin.import', array('bid' => $gbb_id)) ?>">Import</a> | <a href="<?php print \Drupal::url('gavias_blockbuilder.admin.export', array('bid' => $gbb_id)) ?>">Export</a> )
   </div>
